...
class economia(commands.Cog):
    ...
    @discord.slash_command(name = 'adchygcoins', description = 'Adiciona hyg coins a um membro')
    ...
    @discord.slash_command(name = 'rmvhygcoins', description = 'Remove hyg coins a um membro')
    @discord.option(name = 'membro', description = 'Mencione o membro')
    @discord.option(name = 'hygcoins', description = 'Coloque a quantidade de hygcoins')
